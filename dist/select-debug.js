define("arale/select/1.0.0/select-debug", [ "arale/overlay/1.0.1/overlay-debug", "$-debug", "arale/position/1.0.0/position-debug", "arale/iframe-shim/1.0.1/iframe-shim-debug", "arale/widget/1.0.3/widget-debug", "arale/base/1.0.1/base-debug", "arale/class/1.0.0/class-debug", "arale/events/1.0.0/events-debug", "arale/widget/1.0.3/templatable-debug", "gallery/handlebars/1.0.0/handlebars-debug" ], function(require, exports, module) {
    ...
    var Select = Overlay.extend({
        ...
        removeOption: function(option) {
            ...
            var oldIndex = this.get("selectedIndex"), removedOption = this.options.eq(removedIndex);
            // 删除 option，更新属性
